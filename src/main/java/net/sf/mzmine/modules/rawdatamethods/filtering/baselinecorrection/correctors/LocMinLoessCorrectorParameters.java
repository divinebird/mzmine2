...
public class LocMinLoessCorrectorParameters extends SimpleParameterSet {
	 ...
	 */
	public static final DoubleParameter BW = new DoubleParameter(
			"bw",
	...
	public ExitCode showSetupDialog(Window parent, boolean valueCheckRequired) {
		BaselineCorrectorSetupDialog dialog = new BaselineCorrectorSetupDialog(parent, valueCheckRequired, this, LocMinLoessCorrector.class);
