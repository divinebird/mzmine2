...
/*implements TaskListener*/ {
	 ...
	 */
    public BaselineCorrectorSetupDialog(Window parent, boolean valueCheckRequired, ParameterSet correctorParameters,
		...
		public void updateStatus(TaskStatus status) {
			...
			if (this.getStatus() == TaskStatus.ERROR) {
				...
				MZmineCore.getDesktop().displayErrorMessage(
						BaselineCorrectorSetupDialog.this, "Error of preview task ", this.getErrorMessage());
				hidePreview();
			} 
		}
	}
